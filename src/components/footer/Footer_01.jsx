      ...
      <div className="global-container">
        ...
        <div className="lg grid grid-cols-1 gap-10 py-[60px] md:grid-cols-3 xl:grid-cols-3 xl:gap-20 xl:py-[100px]">
          ...
          <div className="flex flex-col gap-y-6 text-center md:text-left">
            ...
            <p>
              Our mission is to to Bring Millions of Indian farmers and all the
              related stake holdersinto Digital Agri trading ecosystem.
            </p>
          </div>
          {/* Footer Widget */}
          {/* Footer Widget */}
          <div className="flex flex-col gap-y-6 items-center md:items-start md:text-left">
            {/* Footer Title */}
