  ...
  return (
    <>
      ...
      <section id="section-hero">
        <div className="relative z-[1] overflow-hidden rounded-bl-[30px] rounded-br-[30px] bg-colorLinenRuffle pb-4 sm:pt-16 pt-12 lg:rounded-bl-[50px] lg:rounded-br-[50px] lg:pb-24 lg:pt-16 xl:pt-16 xxl:pb-[133px] xxl:pt-[195px]">
            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12">
              <div className="mb-14 flex flex-col items-center text-center lg:mb-20 lg:items-start lg:text-left order-2 lg:order-1">
                ...
                <p className="jos slide-from-bottom mb-11 max-w-[700px] text-lg font-semibold sm:text-xl xl:max-w-[980px]">
                  Openmarket changes everything, India's first fully digital
                  platform transforming the way agricultural commodities are
                  bought and sold.
                </p>
                <div
